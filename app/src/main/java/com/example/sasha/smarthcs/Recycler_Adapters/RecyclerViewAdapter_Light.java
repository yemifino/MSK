...
public class RecyclerViewAdapter_Light extends RecyclerView.Adapter<RecyclerViewAdapter_Light.ViewHolder> {
    ...
    public RecyclerViewAdapter_Light(Resources resources) {
